...
public class CrossfadeDrawerLayoutActvitiy extends AppCompatActivity implements DrawerLayout.DrawerListener  {
    //save our header or result
    private AccountHeader headerResult = null;
    private Drawer result = null;
    private CrossfadeDrawerLayout crossfadeDrawerLayout = null;
    private CardView mainView = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
         mainView = (CardView) findViewById(R.id.frame_container);
        ...
        result = new DrawerBuilder()
                ...
                .addDrawerItems(
                        new PrimaryDrawerItem().withName("hi").withIcon(R.drawable.ic_menu_camera).withIdentifier(1)
...
//                        new SecondaryDrawerItem().withName(R.string.drawer_item_contact).withIcon(GoogleMaterial.Icon.gmd_format_color_fill).withTag("Bullhorn")
        ...
        crossfadeDrawerLayout.addDrawerListener(CrossfadeDrawerLayoutActvitiy.this);
...
/**
    ...
    public void onDrawerSlide(View drawerView, float slideOffset) {
     //   float moveFactor = navView.getWidth() * slideOffset;
        //if(slideOffset>0.80) {
            Log.v("Say", "" + slideOffset);
            float moveFactor = crossfadeDrawerLayout.getSmallView().getWidth() * slideOffset;
            mainView.setTranslationX(moveFactor);
            mainView.setScaleX(1 - slideOffset / 4);
            mainView.setScaleY(1 - slideOffset / 5);
            mainView.setCardElevation(slideOffset * (15 * toPx(CrossfadeDrawerLayoutActvitiy.this)));
       // }
    }
